...
public class Livro {
	...
	/**
	 * Metódo utlizado para cadastro de novos exemplares a partir dos seguintes atributos
	...
	/**
	 * Metódo utlizado para consulta de livros a partir dos seguintes atributos:
	 * @param numCodigo - Número de Código do Livro
	...
	/**
	 * Metódo utilizado para atualização de dados dos Livros a partir dos seguintes atributos
	...
	/**
	 * Metódo utilizado para deletar livros no banco a partir dos seguintes atributos
	 * @param numCodigo - Código do Livro
	 * @param titulo - Titulo do Livro
