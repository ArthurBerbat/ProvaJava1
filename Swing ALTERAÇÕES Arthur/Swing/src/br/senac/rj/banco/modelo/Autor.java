...
public class Autor {
	...
	/**
	 * Metódo utlizado para o cadastro de autores a partir dos seguintes atributos
	...
	/**
	 * Metódo utlizado para consulta de autores de acordo com atributos abaixo
	 * @param numMatricula - Número de Matrícula do autor
	 * @param nome - Nome do Autor
	...
	/**
	 * Metódo utilizado para atualização de dados de autores a partir dos seguintes atributos:
	 * @param numMatricula - Número de matrícula do autor
	 * @param nome - Nome do autor
	 * @param nacionalidade - Nacionalidade do autor
	 * @param numCPF - CPF do autor
	...
	public boolean atualizarDadosAutor(int numMatricula, String nome, String nacionalidade, int numCPF) {
		...
		/**
		 * Metódo utilizado para exclusão de autores a partir dos seguintes atributos
		 * @param numMatricula - Número de matrícula do autor
		 * @param nome - Nome do Autor
		 * @param nacionalidade - Nacionalidade do autor
		 * @param numCPF - CPF do autor
