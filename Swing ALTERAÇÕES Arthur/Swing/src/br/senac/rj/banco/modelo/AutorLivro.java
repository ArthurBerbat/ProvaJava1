...
public class AutorLivro {
	...
	/**
	 * Metódo utlizado para cadastro de dados editoriais a partir dos seguintes atributos
	...
	/**
	 * Metódo utilizado para consulta de dados editorais a partir dos seguintes atributos:
	 * @param numCodAutor - Código do autor
	 * @param numCodLivro - Código do Livro
	...
	/**
	 * Metódo utilizado para atualização dos dados editoriais para a partir dos seguintes atributos:
	 * @param numCodAutor - Código do autor
	 * @param numCodLivro - Código do livro
	 * @param numCodEditora - Código da Editora
	...
	/**
	 * Metódo utlizado para a exclusão de dados editoriais de acordo com os seguintes atributos
	 * @param numCodAutor - Código do autor
	 * @param numCodLivro - Código do Livro
	 * @param numCodEditora - Código da Editora
	 * @param editora - Nome da Editora
